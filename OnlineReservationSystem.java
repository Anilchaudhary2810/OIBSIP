...
class ReservationSystem {
    ...
    private final String[] verifiedUsers = {"anil", "vinod", "prince", "bharat", "utsav"};
    private final byte[] verifiedPass = {1, 2, 3, 4, 5};
    ...
    private final String[] traintype = {"Second Class", "Sleeper class-AC", "First Class", "Sleeper Class-AC", "Sleeper Class-Non-AC"};
    private final String[] dateOfJourney = {"25/06/2024", "27/06/2024", "01/07/2024", "03/07/2024", "03/07/2024"};
    ...
    private final String[] PNRnumber = {"25-6-T1-12345", "27-6-T2-23456", "01-7-T3-34567", "03-7-T4-45678", "03-7-T5-56789"};
